...
describe('Get elements test suite', () => {

    it('Get element options', () => {
    ...
    it('Contains and chains DOM test', () => {
        cy.visit('/')
        cy.contains('Forms').click()
        cy.contains('Form Layouts').click()
    ...
    it('save subject of the command with Alias or Then', () => {
        cy.visit('/')
        cy.contains('Forms').click()
        cy.contains('Form Layouts').click()
    ...
    it('extract text values from elements', () => {
        cy.visit('/')
        cy.contains('Forms').click()
        cy.contains('Form Layouts').click()
